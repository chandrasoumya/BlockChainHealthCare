...
contract Healthcare {
    ...
    function getAdminNameByAddress(
    ...
    function getDoctorNameByAddress(
    ...
    function addPatient(
        ...
        idCounter++;
        patients[idCounter].biodata = bio(
            idCounter,
            name,
            ph,
            dob,
    ...
    function getPatientId() external view onlyDoctor returns(uint256) {
        return idCounter;
    }
